...
```bash
python3 balloon.py splash --weights=/path/to/samples/balloon/mask_rcnn_balloon.h5 --image=<file name or URL>
```

Apply splash effect on a video. Requires OpenCV 3.2+:

```bash
python3 balloon.py splash --weights=/path/to/samples/balloon/mask_rcnn_balloon.h5 --video=<file name or URL>
```
...
```
python3 balloon.py train --dataset=/path/to/samples/balloon/dataset --weights=coco
```

Resume training a model that you had trained earlier
```
python3 balloon.py train --dataset=/path/to/samples/balloon/dataset --weights=last
```

Train a new model starting from ImageNet weights
```
python3 balloon.py train --dataset=/path/to/samples/balloon/dataset --weights=imagenet
```
