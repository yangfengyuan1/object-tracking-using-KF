...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            class GtBoxes(KL.Layer):
                def __init__(self, name='GtBoxes', **kwargs):
                    super(GtBoxes,self).__init__(name=name,**kwargs)
                    self.input_image=input_image
                def call(self,x):
                    return norm_boxes_graph(
                            x, K.shape(self.input_image)[1:3])
            
            gt_boxes = GtBoxes()(input_gt_boxes)
        ...
        if mode == "training":
            ...
            class Anchors(KL.Layer):
                def __init__(self, name='Anchors',**kwargs):
                    super(Anchors, self).__init__(name=name, **kwargs)
                    self.anchors=anchors
                def call(self, x):
                    return tf.Variable(self.anchors)
            anchors = Anchors()(input_image)
