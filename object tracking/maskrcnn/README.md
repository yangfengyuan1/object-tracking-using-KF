# [TF 2.X] Mask R-CNN for Object Detection, Segmentation and 3D Detection

[Notice] : The original mask-rcnn uses the tensorflow 1.X version. I modified it for tensorflow 2.X version.

### New Features

Here are 3 new files for 3D detection using the Mask_RCNN and vanishing points:

* detectBottom.py
* detect3D.py
* detect3D_batch.py

All the 3 files need an extra `config` file to specify the vanishing points of the road. You can find a demo data in: https://data.mendeley.com/datasets/xr38s95sm9/

You can use `python3 <detect3D.py> --help` to see help menu of the detect3D.

In addition, for the convenience of testing the results from MaskRCNN, we provide a python file to evaluation MaskRCNN on image, video, or folder contain multiple images:

```bash
python3 evaluation.py <image/video/folder>
```
